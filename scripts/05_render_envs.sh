...
# Traefik env with BASIC auth and dashboard host
...
echo "Rendered envs."
echo "  - Traefik BASIC creds in secrets/traefik_basic.txt"
echo "  - DB root pass in secrets/db_password.txt"
echo "  - ERPNext admin pass in secrets/admin_password.txt"
